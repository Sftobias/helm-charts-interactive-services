...
| service.image.custom.version | string | `"inseefrlab/onyxia-jupyter-tensorflow:py3.12.9-gpu"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-jupyter-tensorflow:py3.12.9-gpu"` |  |
