...
| service.image.custom.version | string | `"inseefrlab/onyxia-jupyter-tensorflow:py3.13.5"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-jupyter-tensorflow:py3.13.5"` |  |
