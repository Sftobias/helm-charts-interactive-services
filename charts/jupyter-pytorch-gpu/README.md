...
| persistence.storageClass | string | `"cinder-sci"` |  |
...
| service.image.custom.version | string | `"inseefrlab/onyxia-jupyter-pytorch:py3.13.5-gpu"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-jupyter-pytorch:py3.13.5-gpu"` |  |
