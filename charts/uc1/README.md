...
| configEnvVars[0].value | string | `"{{ printf \"/home/%s/work/s3/%s/job/%s/inputs/model.json\" .environment.user (trimAll \"/\" .s3.workingDirectoryPath) (regexFind \"[0-9]{6}$\" .Release.Name) }}"` |  |
