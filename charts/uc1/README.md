...
| configEnvVars[0].value | string | `"{{ printf \"/home/%s/work/sharedData/uc1_data/model_SIESTA_0_13012025.json\" .environment.user }}"` |  |
...
| configEnvVars[12].value | string | `"{{ printf \"/home/%s/work/sharedData/uc1_data/outputs/out_data_preprocessor\" .environment.user }}"` |  |
| configEnvVars[13].name | string | `"OUT_PREVIOUS_PARAMETRIZATION"` |  |
| configEnvVars[13].value | string | `"{{ printf \"/home/%s/work/sharedData/uc1_data/outputs/out_data_previous_parametrization\" .environment.user }}"` |  |
| configEnvVars[14].name | string | `"OUT_DAY_SIMULATOR"` |  |
| configEnvVars[14].value | string | `"{{ printf \"/home/%s/work/sharedData/uc1_data/outputs/out_data_day_simulator\" .environment.user }}"` |  |
| configEnvVars[15].name | string | `"OUT_DATA_PREPARATION_STEP_SIMULATOR"` |  |
| configEnvVars[15].value | string | `"{{ printf \"/home/%s/work/sharedData/uc1_data/outputs/out_data_preparation_step_simulator\" .environment.user }}"` |  |
| configEnvVars[16].name | string | `"OUT_STEP_SIMULATOR"` |  |
| configEnvVars[16].value | string | `"{{ printf \"/home/%s/work/sharedData/uc1_data/outputs/out_data_step_simulator\" .environment.user }}"` |  |
