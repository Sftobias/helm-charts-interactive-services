...
Lightweight XFCE desktop with VNC endpoint for Apache Guacamole
...
| networking.service.port | int | `6901` |  |
| networking.service.targetPort | int | `6901` |  |
| networking.type | string | `"ClusterIP"` |  |
| networking.user.enabled | bool | `true` |  |
...
| service.image.custom.version | string | `"accetto/ubuntu-vnc-xfce-g3:latest"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"accetto/ubuntu-vnc-xfce-g3:latest"` |  |
...
| xfce.vncPassword | string | `"changeme"` |  |
| xfce.vncPort | int | `5901` |  |
| xfce.webPort | int | `6901` |  |
